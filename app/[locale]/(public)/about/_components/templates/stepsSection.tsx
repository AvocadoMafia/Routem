...
export default function StepsSection() {
    ...
    return (
        <section className={'w-full h-fit p-6 md:p-12 bg-foreground-1/15 backdrop-blur-sm flex justify-center'}>
            <div className={'w-full max-w-[1000px] h-fit flex flex-col gap-6'}>
                <h2 className={'text-3xl md:text-5xl text-foreground-0 text-center font-bold leading-relaxed border-y border-foreground-0/30 w-full py-3'}>{t('stepsTitle')}</h2>
                <div className={'w-full h-fit grid grid-cols-1 md:grid-cols-4'}>
                    <div className={'w-full flex flex-col gap-3 p-6 border-b md:border-b-0 md:border-r border-foreground-0/30'}>
