...
export default function StatsSection() {
    ...
    return (
        <div className={'w-full theme-reversed bg-background-0 flex justify-center'}>
            <div className={'w-full max-w-[1000px] py-16 grid grid-cols-1 md:grid-cols-3'}>
                <div className={'w-full h-fit flex flex-col gap-3 border-b md:border-b-0 md:border-r border-foreground-0/30 p-6 md:p-3'}>
                ...
                <div className={'w-full h-fit flex flex-col gap-3 border-foreground-0/30 p-6 md:p-3'}>
