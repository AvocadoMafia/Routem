...
export default function ContentsSelector(props: Props) {
    ...
    return (
        <div className={'shrink-0 w-fit h-fit sticky top-2 z-40 bg-background-1/90 backdrop-blur-sm flex items-center justify-start md:justify-center gap-1 md:gap-2 px-2 py-2 border border-grass overflow-x-auto no-scrollbar rounded-full shadow-sm'}>
