 ...
 */
export function buildRouteNodesFromItems(items: postRouteType["items"] | PatchRouteType["items"]): Prisma.RouteNodeCreateWithoutRouteInput[] {
    if (!items) return [];
 ...
 */
export function buildCreateRouteData(body: postRouteType, authorId: string): Prisma.RouteCreateInput {
