      ...
      >
        ...
        <div className="w-full md:w-1/2 md:min-w-[500px] h-full md:h-auto p-3 overflow-hidden flex flex-col justify-center items-center gap-6 md:block hidden @container relative z-10 opacity-100 backdrop-blur-xs">
          ...
          <div className={'flex flex-col gap-4 items-center'}>
            ...
            <Link href="/login">
              <h3 className={'text-2xl w-fit text-foreground-0 pb-1 px-2 border-b-2 border-foreground-0 hover:opacity-80 transition-opacity'}>{t('signIn')} →</h3>
            </Link>
          </div>
        </div>
        ...
        <div
          ...
          <div className="w-full max-w-sm space-y-8">
            <div className="text-center">
              <h2 className="text-3xl font-bold tracking-tight text-foreground-0">{t('signUp')}</h2>
            ...
            <form className="mt-8 space-y-6" onSubmit={handleSignup}>
              ...
              <div className="space-y-4">
                ...
                <div className="md:hidden text-center">
                  <span className="text-sm text-foreground-1">{t('hasAccount')} </span>
