...
export default function SignupTypography() {
  return (
      <div className="absolute xl:right-20 lg:right-15 right-10 xl:bottom-20 lg:bottom-15 bottom-10 z-20 text-white pointer-events-none hidden md:block text-right">
        <motion.div
        ...
        >
          <div className={'flex items-center gap-6'}>
              <img className={'xl:w-24 ld:w-16 h-12 xl:h-24 ld:h-16 h-12'} src={'/logoMono.svg'}/>
