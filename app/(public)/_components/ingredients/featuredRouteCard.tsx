        ...
        <div className="absolute inset-0 p-4 flex flex-col justify-between text-white">
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              <div className="flex-1 flex items-center justify-center gap-1.5 py-1.5 px-2 backdrop-blur-md rounded-full bg-background-1 text-foreground-0 transition-colors">
