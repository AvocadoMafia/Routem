...
const DetailsViewer = memo(function DetailsViewer({
  route,
  items,
  focusIndex,
  viewMode,
  ...
  return (
    <div
      ...
      className={`w-full h-full overflow-y-scroll lg:px-12 md:px-6 px-3 md:pt-6 pt-3 pb-40 flex flex-col gap-10 transition-all duration-500 ${
        viewMode === "details"
        ...
        <>
          ...
          <div
            ...
            className={`transition-all duration-700 ease-[0.22, 1, 0.36, 1] border-t pt-16 border-grass ${
              focusIndex === items.length ? "opacity-100" : "opacity-100"
            }`}
          >
